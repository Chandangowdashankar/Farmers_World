...
public class NotificationsActivity extends AppCompatActivity {
	...
	private ArrayList<HashMap<String, Object>> list_noti = new ArrayList<>();
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		listview1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> _param1, View _param2, int _param3, long _param4) {
				...
				i.setClass(getApplicationContext(), ExchangeProductsActivity.class);
				startActivity(i);
			}
		});
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				notifications.addListenerForSingleValueEvent(new ValueEventListener() {
					...
					public void onDataChange(DataSnapshot _dataSnapshot) {
						...
						listview1.setAdapter(new Listview1Adapter(list_noti));
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			_Shadow(5, 20, "#F8BBD0", linear1);
			if (list_noti.get((int)_position).get("first id").toString().equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
				textview1.setText("Hi ".concat(list_noti.get((int)_position).get("first name").toString().concat(" ".concat(list_noti.get((int)_position).get("second name").toString().concat(" has exchange the product with you tap see.")))));
