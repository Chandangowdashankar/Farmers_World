		...
		_user_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				if (_childKey.equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
					username.setText("Username:- ".concat(_childValue.get("display_name").toString()));
					...
					if (_childValue.containsKey("color")) {
						_Shadow(0, 400, _childValue.get("color").toString(), linear_word);
					}
					if (_childValue.containsKey("avatar")) {
						if (_childValue.get("avatar").toString().equals("null")) {
							im_avatar.setVisibility(View.GONE);
							linear_word.setVisibility(View.VISIBLE);
							tx_word.setText(_childValue.get("display_name").toString().substring((int)(0), (int)(2)).toUpperCase());
						}
						else {
							im_avatar.setVisibility(View.VISIBLE);
							linear_word.setVisibility(View.GONE);
			...
			public void onChildChanged(DataSnapshot _param1, String _param2) {
				...
				final HashMap<String, Object> _childValue = _param1.getValue(_ind);
				if (_childKey.equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
					username.setText(_childValue.get("display_name").toString());
					number_.setText(_childValue.get("number").toString());
